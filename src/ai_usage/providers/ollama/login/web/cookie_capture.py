"""Browser cookie-capture login for Ollama Cloud (__Secure-session, optional cf_clearance)."""
...
OLLAMA_LOGIN_URL = "https://ollama.com"
...
class CookieCaptureLogin(LoginMethod):
    ...
    async def authenticate(self, options: dict[str, Any]) -> dict[str, Any] | None:
        ...
        cookies = capture_cookies_via_webview(OLLAMA_LOGIN_URL, self.display_name)
