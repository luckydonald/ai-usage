...
- [x] Update/add frontend tests
- [x] crawl/up: log account add/remove + git-backup toggle (C)
- [x] Live verification: browser (chart) + crawl/up logging
- [x] Run full test suite + ruff, commit
